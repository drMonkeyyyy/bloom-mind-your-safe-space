      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-5 sm:px-8 lg:grid-cols-2 lg:gap-10">
        <div data-reveal>
          ...
          <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
            JN-CALM adalah ruang aman interaktif <strong className="text-foreground font-semibold">yang dirancang oleh Dokter (Built by Doctors)</strong> untuk membantu kamu menghadapi overthinking, stres, burnout, emotional eating, dan berbagai tantangan hidup — tanpa rasa takut dihakimi.
          </p>
